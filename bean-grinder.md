...
## Skills & Agents:
- **`assess` (`skills/assess`)**: Agentic pre-scanning, GCP credential verification, `codmod` intent mapping, dry-run cost estimation, execution of `codmod create`, self-healing log collection (`codmod collect-logs`), and JSON telemetry.
